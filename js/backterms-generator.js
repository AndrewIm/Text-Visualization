                    ...
                    if (d != "") {
                        ...
                        if(allTerms[d]){
                            ...
                            if (allTerms[d][month]) {
                                ...
                                allTerms[d][month].blogs = [];
                                allTerms[d][month].blogs.push(lines);
                                allTerms[d][month].locs = new Object;
                            }
                        ...
                        locationArray.forEach(function(loc){
                            if (!allTerms[d][month].locs[loc])
                                allTerms[d][month].locs[loc] = 1;
                        })
                    ...
                    if (d != "") {
                        ...
                        locationArray.forEach(function (loc) {
                            try {
                                ...
                                console.log("error" +"    "+allTerms[d][month].locs+"   "+ d + " " + month + " " + loc);
                            }
