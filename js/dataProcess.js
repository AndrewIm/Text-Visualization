...
function preProcessData() {
                ...
                personsArray.forEach(function (d) {
                    ...
                    if(d!="") {
                        ...
                        if (allTerms.containsKey(d) == true) {
                            ...
                            temp.blogs.put(lines);
                            allTerms.put(d, temp);
                        }
                        else {
                            var value = {};
                            value.frequency = 1;
                            value.blogs=new Hashtable();
                            value.blogs.put(lines);
    ...
    this.getTerms = function(source,noOfTerms) {
        //
        // get arguments
        ...
        if (arguments[1]!=undefined){
            noOfTerms=arguments[1];
        }
        else
            noOfTerms=-1;
        //
        var topTerms=allTerms.entries().sort(function(a, b){
        ...
        switch (source) {
            case "WN":
                if(noOfTerms==-1)
                    ...
                    return topTerms.slice(0,noOfTerms-1);
                break;
            case "HP":
                return null;
                break;
